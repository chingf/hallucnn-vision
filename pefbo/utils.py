...
class IMAGENET_C(Dataset):
    r"""
    IMAGENET-C dataset including images of specific noise type and noise level.
    """
    def __init__(self, root, noise_type, noise_level, transform=None, target_transform=None):
        all_noises = ["brightness",
                    "contrast",
...
def get_cifar_test_dataloader(mean, std, cifar10=False, batch_size=16, num_workers=2, shuffle=True, root='./data', noise_transform=None, sampler=None, after_norm=True, drop_last=False):
...
class WarmUpLR(_LRScheduler):
    r"""warmup_training learning rate scheduler
    Args:
